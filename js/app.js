  ...
  item.addEventListener("click", (event) => {
    ...
    filteredWorksArray.forEach((work) => {
      ...
      <div class="portfolio__work-example-1">
        <a href="https://massage.onrender.com"><img class="portfolio__work-example-1-img" src="${work.img}" alt="portfolio"></a>
        <div class="portfolio__work-example-1-info">
        <a href="https://massage.onrender.com" class="portfolio__see">مشاهده</a>
